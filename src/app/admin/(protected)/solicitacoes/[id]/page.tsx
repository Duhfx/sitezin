  ...
  return (
    <div>
      <div className="mb-6 flex items-center gap-3">
        ...
        <Badge variant={badgeVariant[req.status as Status]}>{req.status}</Badge>
      </div>
        ...
        {acesso && (
          <Card>
            ...
            <div className="space-y-4">
              <div>
                <p className="text-xs font-medium text-muted-foreground">Link exclusivo</p>
                <p className="mt-0.5 break-all font-mono text-xs text-foreground bg-muted p-2 rounded">
                  {linkMidiaKit}
                </p>
              </div>
                  ...
                  <p className="mt-0.5 text-sm">
                    {acessoAtivo ? (
                      <span className="text-success font-medium">
                        Ativo {acesso.expires_at && `(Expira em ${new Date(acesso.expires_at).toLocaleDateString("pt-BR")})`}
                      </span>
                    ) : (
